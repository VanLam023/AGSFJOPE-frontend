...
export default function LecturerDashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-[#F5F5F5] font-[Inter,sans-serif] text-slate-900">
      {/* ── Sidebar ─────────────────────────────────────────────────────────── */}
      <aside
        className={`${sidebarOpen ? "w-64" : "w-[72px]"} transition-[width] duration-300 ease-in-out flex-shrink-0 flex flex-col bg-[#2D2D2D] border-r border-slate-800 shadow-xl z-20 h-screen sticky top-0`}
      >
        {/* Logo */}
        <div className="px-5 py-5 flex items-center gap-3 border-b border-slate-700/50">
          ...
          {sidebarOpen && (
            <div className="min-w-0">
              ...
              <p className="text-slate-400 text-[9px] mt-0.5 uppercase tracking-widest">
                FPT University
              </p>
            </div>
          )}
          ...
          {[
            ...
            >
              <div className="relative flex-shrink-0">
                <span
                  className={`material-symbols-outlined text-[20px] ${item.active ? "text-[#F37021]" : "group-hover:text-slate-200"}`}
                >
                  {item.icon}
                </span>
                {item.badge > 0 && (
              ...
              {sidebarOpen && (
                <span
                  className={`text-sm font-semibold truncate ${item.active ? "font-bold text-[#F37021]" : ""}`}
                >
                  {item.label}
                </span>
              )}
        ...
        >
          ...
          >
            <div className="relative flex-shrink-0">
              <div
                className={`size-9 rounded-full bg-[#F37021]/20 ring-2 transition-all flex items-center justify-center text-[#F37021] font-bold text-sm
            ...
            {sidebarOpen && (
              <>
                ...
                <span
                  className={`material-symbols-outlined text-slate-400 text-[18px] transition-transform duration-200 ${sidebarDropdownOpen ? "rotate-180" : ""}`}
                >
                  expand_less
                </span>
              </>
        ...
        <header className="bg-white h-16 border-b border-slate-200 px-8 flex items-center justify-between sticky top-0 z-10 shadow-sm">
          ...
          <div className="flex items-center gap-6">
            ...
            <NotificationBell
              ...
              buttonClassName="w-10 h-10 rounded-xl text-slate-500 hover:text-[#F37021] hover:bg-slate-100 flex items-center justify-center"
            ...
            <div className="relative" ref={headerDropdownRef}>
              ...
              >
                ...
                <div
                  className={`size-10 rounded-full bg-[#F37021]/20 ring-2 transition-all flex items-center justify-center text-[#F37021] font-bold text-sm
          ...
          <div className="p-8 space-y-6 max-w-7xl mx-auto w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="relative overflow-hidden bg-white rounded-3xl border border-slate-200/80 shadow-sm p-6 flex items-center gap-5 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                <span className="material-symbols-outlined absolute -right-2 -bottom-2 text-[90px] text-slate-900/[0.035] pointer-events-none select-none">
                  task
                </span>
                ...
                <div>
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.18em] mb-1.5">
                    Assigned Appeals
                  </p>
              ...
              <div className="relative overflow-hidden bg-gradient-to-br from-[#FFF4EE] to-white rounded-3xl border border-[#F37021]/20 shadow-sm p-6 flex items-center gap-5 hover:shadow-md hover:shadow-orange-100 hover:-translate-y-0.5 transition-all duration-200">
                <span className="material-symbols-outlined absolute -right-2 -bottom-2 text-[90px] text-[#F37021]/[0.08] pointer-events-none select-none">
                  check_circle
                </span>
                <div className="w-12 h-12 rounded-2xl bg-[#F37021]/10 border border-[#F37021]/20 flex items-center justify-center flex-shrink-0">
                  <span className="material-symbols-outlined text-[#F37021] text-[22px]">
                    check_circle
                  </span>
                </div>
                <div>
                  <p className="text-[10px] font-black text-[#F37021]/50 uppercase tracking-[0.18em] mb-1.5">
                    Completed Reviews
                  </p>
                  <h3 className="text-4xl font-black text-[#F37021] leading-none">
                    {stats.completed}
                  </h3>
                </div>
              </div>
              ...
              <div className="relative overflow-hidden bg-gradient-to-br from-red-50 to-white rounded-3xl border border-red-200/60 shadow-sm p-6 flex items-center gap-5 hover:shadow-md hover:shadow-red-100 hover:-translate-y-0.5 transition-all duration-200">
                <span className="material-symbols-outlined absolute -right-2 -bottom-2 text-[90px] text-red-500/[0.07] pointer-events-none select-none">
                  error
                </span>
                ...
                <div>
                  <p className="text-[10px] font-black text-red-400 uppercase tracking-[0.18em] mb-1.5">
                    Overdue Appeals
                  </p>
              ...
              <div className="px-7 py-5 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-slate-50 to-white">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-xl bg-[#F37021]/10 flex items-center justify-center">
                    <span className="material-symbols-outlined text-[#F37021] text-[18px]">
                      assignment
                    </span>
                  </div>
                  <div>
                    <h3 className="text-sm font-black text-slate-800 leading-none">
                      Đơn phúc khảo được phân công
                    </h3>
                    <p className="text-[11px] text-slate-400 mt-1">
                      Danh sách sinh viên yêu cầu chấm lại bài thi
                    </p>
                  </div>
                </div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-slate-50/80 border-b border-slate-100">
                      <th className="px-6 py-3.5 text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] w-10 text-center">
                        #
                      </th>
                      <th className="px-6 py-3.5 text-[10px] font-black text-slate-400 uppercase tracking-[0.15em]">
                        Sinh viên
                      </th>
                      <th className="px-6 py-3.5 text-[10px] font-black text-slate-400 uppercase tracking-[0.15em]">
                        Kỳ thi
                      ...
                      <th className="px-6 py-3.5 text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] text-center">
                        Hành động
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100 text-sm">
                    {appeals.map((appeal, idx) => (
                      ...
                      >
                        <td className="px-6 py-4 text-slate-400 text-xs font-bold text-center">
                          {idx + 1}
                        </td>
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`text-xs font-bold flex items-center gap-0.5 ${appeal.overdue ? "text-red-600" : "text-slate-600"}`}
                          >
                            {appeal.overdue && (
                  ...
                  <div className="flex gap-4 items-start">
                    <div className="flex flex-col items-center flex-shrink-0">
                      <div className="w-8 h-8 rounded-full bg-red-100 border-2 border-red-400 flex items-center justify-center shadow-sm shadow-red-100">
                        <span className="material-symbols-outlined text-red-500 text-[15px]">
                          warning
                        </span>
                      </div>
                    ...
                    <div className="flex-1 pb-2">
                      ...
                      <div className="mt-1.5 bg-red-50/60 border border-red-200/60 rounded-2xl p-4">
                        <h4 className="text-sm font-bold text-slate-800">
                          OOP Quiz 2 — Phạm Văn D
                        </h4>
                        <div className="flex items-center gap-1.5 mt-1.5">
                          <span className="material-symbols-outlined text-red-400 text-[13px]">
                            calendar_today
                          </span>
                  ...
                  <div className="flex gap-4 items-start">
                    <div className="flex flex-col items-center flex-shrink-0">
                      <div className="w-8 h-8 rounded-full bg-[#F37021]/10 border-2 border-[#F37021]/50 flex items-center justify-center shadow-sm shadow-orange-100">
                        <span className="material-symbols-outlined text-[#F37021] text-[15px]">
                          schedule
                        </span>
                      </div>
                    ...
                    <div className="flex-1 pb-2">
                      <span className="text-[9px] font-black text-[#F37021] uppercase tracking-[0.2em]">
                        Trong 24h tới
                      </span>
                      <div className="mt-1.5 bg-orange-50/60 border border-[#F37021]/15 rounded-2xl p-4">
                        <h4 className="text-sm font-bold text-slate-800">
                          OOP Final Exam — Nguyễn Văn A
                        </h4>
                        <div className="flex items-center gap-1.5 mt-1.5">
                          <span className="material-symbols-outlined text-slate-400 text-[13px]">
                            calendar_today
                          </span>
